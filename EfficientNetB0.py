...
def train_model(model, train_loader, val_loader):
    ...
    print("=" * 55)
    print("STEP 4: Training EfficientNet-B0")
    print("=" * 55)
    ...
    for epoch in range(1, CONFIG["num_epochs"] + 1):
        ...
        if epoch == CONFIG["fine_tune_epoch"]:
            print("\n>>> Unfreezing entire EfficientNet backbone...\n")
            for param in model.parameters():
    ...
    print(f"\nBest model saved to: best_model_efficientnet_b0.pth")
    return history
...
def plot_results(history, all_labels, all_preds, class_names):
    ...
    fig.suptitle("EfficientNet-B0 — Training Results", fontsize=13,
                 fontweight="bold")
    ...
    plt.show()
    print("Saved: training_curves_efficientnet_b0.png, confusion_matrix_efficientnet_b0.png")
...
def predict_image(image_path, model, class_names, device):
    ...
    fig.suptitle(f"EfficientNet-B0 — Gonadal Stage Prediction\n"
    ...
    axes[1].invert_yaxis()
    plt.tight_layout()
    out_path = os.path.splitext(image_path)[0] + "_efficientnet_b0_prediction.png"
